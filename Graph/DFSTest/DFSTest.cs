...
namespace DFSTest
{
    ...
    public class DFSTest
    {
        ...
        public void TestTraversal()
        {
            ...
            ArrayList T = DFS.traversal(n1);
            Assert.IsTrue(T.Count == 11);
            Assert.IsTrue(T[0] == n1);
            Assert.IsTrue(T[1] == n2);
            Assert.IsTrue(T[2] == n5);
            Assert.IsTrue(T[3] == n3);
            Assert.IsTrue(T[4] == n8);
            Assert.IsTrue(T[5] == n9);
            Assert.IsTrue(T[6] == n7);
            Assert.IsTrue(T[7] == n6);
            Assert.IsTrue(T[8] == n4);
            Assert.IsTrue(T[9] == n11);
        ...
        public void TestLinkedListPath()
        {
            ...
            // Test
            ArrayList path12 = GraphAPI.DFS_path(n1, n2);
            Assert.IsTrue(path12.Count == 2);
            Assert.IsTrue(path12[0] == n1);
            Assert.IsTrue(path12[1] == n2);

            ArrayList path13 = GraphAPI.DFS_path(n1, n3);
        ...
        public void TestLinkedListReverse()
        {
            ...
            ArrayList path21 = GraphAPI.DFS_path(n2, n1);
        ...
        public void TestGraph()
        {
            ...
            // n1 -> n2 -> n3 -> n8
            ArrayList path18 = GraphAPI.DFS_path(n1, n8);
            ...
            // n10 -> n9 -> n3 -> n2 -> n1 -> n4 -> 6
            ArrayList path106 = GraphAPI.DFS_path(n10, n6);
            Assert.IsTrue(path106.Count == 7);
            Assert.IsTrue(path106[0] == n10);
            Assert.IsTrue(path106[1] == n9);
            Assert.IsTrue(path106[2] == n3);
            Assert.IsTrue(path106[3] == n2);
            Assert.IsTrue(path106[4] == n1);
            Assert.IsTrue(path106[5] == n4);
            Assert.IsTrue(path106[6] == n6);
        }
    }
}
